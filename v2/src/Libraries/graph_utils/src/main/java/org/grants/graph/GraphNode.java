...
public class GraphNode {
	...
	public GraphNode(Collection<String> labels, Map<String, Object> properties) {
		setLabels(labels);
		setProperties(properties);
	}
	
	public GraphNode(Collection<String> labels, Map<String, Object> properties, Collection<GraphIndex> indexes) {
		setLabels(labels);
		setProperties(properties);
		setIndexes(indexes);
	}
	
	public GraphNode(Collection<String> labels, Map<String, Object> properties, GraphIndex index) {
		setLabels(labels);
		setProperties(properties);
		addIndex(index);
	}
